...
const API_APPID = process.env.OPEN_WEATHER_API_KEY;
const API_UNPSLASH = process.env.UNSPLASH_API_KEY;
...
const DEF_N_D_H = `https://api.openweathermap.org/data/2.5/onecall?exclude=minutely&appid=${API_APPID}&lat=23.8041&lon=90.4152`;
...
const SEARCH_DEFAULT = `${URL_UNSPLASH}?client_id=${API_UNPSLASH}&page=1&query=Dhaka`;
